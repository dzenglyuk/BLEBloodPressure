...
import { FlatList, ListRenderItemInfo, Modal, SafeAreaView, Text, StyleSheet } from 'react-native';
...
const DeviceModalListItem: FC<DeviceModalListItemProps> = (props) => {
  ...
  return <Button title={item.item.name} onPress={connectAndCloseModal} />;
};
